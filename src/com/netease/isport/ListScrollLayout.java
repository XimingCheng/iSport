...
public class ListScrollLayout extends ViewGroup {
...
//    private int mTouchState = TOUCH_STATE_REST;
	...
	public ListScrollLayout(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		init(context);
	}	
	public ListScrollLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		init(context);
	}
	
	public ListScrollLayout(Context context, AttributeSet attrs, int defStyle) {
